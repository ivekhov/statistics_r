...
# 4 charts 
# QQPlot
# residuals squared VS fitted values
# residuals VS fitted values 
# Cook distance: standartized VS Leverage 



####################
setwd("~/Dropbox/work/statistics_r/computer_science_center/linear_regression/03_series_g")
